...
public class ArrayEx1 {
    public static void main(String[] args) {
        ...
        // <문제;배열>
        // 학생 100명의 점수를 입력
        // int[] 배열명 = new int[100]; //배열 선언, 생성하는 방법
        ...
        // <문제;배열>추출 및 수정
        int[] scores2 = { 85, 65, 95, 74, 100 }; // 배열은 연속되는 공간을 쓰며, 그때 index를 사용한다.
        ...
        // System.out.println(scores2[5]); → Array Index Out Of Bounds Exception
        // 왜? 인덱스가 4번까지만 있기 때문.
